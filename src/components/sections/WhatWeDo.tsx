        ...
        <div className="mt-14 grid gap-8 md:grid-cols-3">
          {whatWeDo.services.map((service, i) => (
            <Reveal key={service.number} delay={i * 0.1}>
              <article className="h-full rounded-lg border border-border-subtle border-t-4 border-t-crux-blue bg-white p-8 shadow-sm transition-all duration-200 ease-crux hover:-translate-y-0.5 hover:shadow-md motion-reduce:transform-none motion-reduce:transition-none">
